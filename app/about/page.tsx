...
export const metadata: Metadata = {
  title: "About Delta Chi Alberta | Delta Chi Alberta, Canada",
  description:
    "Learn about Delta Chi Fraternity at the University of Alberta. Our history, brotherhood, and commitment to Delta Chi Alberta, Canada. Brotherhood of a lifetime.",
  openGraph: {
    title: "About Delta Chi Alberta | Delta Chi Alberta, Canada",
    description: "Our history, brotherhood, and commitment. Delta Chi Alberta.",
  },
};
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
      ...
      <section className="mt-12">
        <h2 className="text-2xl font-semibold text-delta-navy dark:text-white">
          A Brief History
        </h2>
        <div className="mt-6 space-y-4 text-gray-700 dark:text-gray-300">
          <p>
            Following in the traditions and values that the founding fathers of Delta Chi intended, Alberta Chapter of the Delta Chi fraternity, although young, has been an exemplary example of balancing academic, social and individual development. Part of a network of 135 chapters across the United States and Canada, Alberta Chapter is furthest north position in Delta Chi to date. Colonized on April 1st 1995, Alberta Chapter has earned the respect of the University community through its active participation and organization of philanthropy events, positions in leadership organizations, academic diligence and athletic participation. Members within the fraternity are held to a high moral standard which is codified within the regulations of the fraternity, referred to as the Eleven Basic Expectations. Focusing on nurturing a balanced healthy lifestyle for its members, Alberta Chapter remains as an exemplar of Greek life on campus.
          </p>
        </div>
      </section>
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 space-y-4 text-gray-700 dark:text-gray-300">
          ...
          <p>
            Two incidents have been credited with providing the impetus for renewed interest in the
            founding of what was to become Delta Chi. One was the election of a Phi Delta Phi as the
          ...
          <p>
            The question of who first conceived the idea of a new fraternity will probably never be
            answered. According to Frederick Moore Whitney there were probably two or three groups
            working on the idea that spring.
          </p>
          <p>
            ...
            remember approaching Sweetland about the concept of the new fraternity and how excited
            he was, and how he had joined right in. Sweetland said he always had considered the
            founding of Delta Chi to date back to when he had unfolded the whole idea to Crandall.
          </p>
          <p>
            While the class officer elections and the Law School Editorship incidents may have provided
            the initial incentives for organization, it soon became clear that those involved were looking
            for much more. Realizing a common desire for fellowship and intellectual association, they
            sought to enrich their college experiences by creating among themselves a common bond;
            a bond that would materially assist each in the acquisition of a sound education; a bond that
            would provide each enduring value. As with any important commitment, there must be time
            for contemplation and planning.
          </p>
          <p>
            Over the summer, many of the details of the organization were worked out by Crandall, who
            had stayed in Ithaca until after school opened. There was additional work accomplished by
            Sweetland, John Milton Gorham and Stillman.
          </p>
          <p>
            In regards to the adoption of the constitution, Albert Sullard Barnes wrote the following in his
          ...
          <p>
            ...
            until October 13, 1890, there existed, in effect, a fraternity which had no chapters.
          </p>
          <p>
            ...
            practicing law in Ithaca. Despite this, Crandall was listed as an active charter member of the
            Cornell Chapter on October 13, 1890. It was at his insistence, with it is assumed, the
            support of the majority of the members present, that Frank Thomas was listed as an
            honorary member. Sweetland was listed as an honorary charter member. Several of the
            Founders were working on their masters of Law degrees when the Fraternity was being
            organized.
          </p>
          <p>
          ...
          <p>
            ...
            nine men who he then believed to be the Founders of Delta Chi with an enlarged picture of
            Sweetland in its center. He later had that composite removed when he determined that he
            had left out one or two men.
          </p>
        </div>
      </section>
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 space-y-4 text-gray-700 dark:text-gray-300">
          ...
          <p>
            On April 14, 1891, John Francis Tucker, of New York University, went to Ithaca and earned
            the confidence and regard of the Cornell Chapter. He was initiated into Delta Chi that night
            and was sent back to prepare his associates for induction.
          </p>
          <p>
            Although Stillman remembers Tucker (who was a member of Delta Upsilon) coming to find
          ...
          <blockquote className="ml-4 border-l-4 border-delta-red pl-4 italic text-gray-600 dark:text-gray-400">
            ...
            make formal application in writing for a charter from our ancient and honorable body.
          ...
          <p>
            One solution to the confusion is the possibility that Delta Chi was originally founded as a
            national fraternity, but with the pressures of school work and the chapter at Cornell to keep
            them busy, the Founders allowed the national organization to take a back seat. When
            Tucker appeared the next spring, the national organization had to be reorganized in order to
            accommodate the applicant from N.Y.U.
          </p>
          <p>
            As it turned out, Tucker played a significant role in the development of the Fraternity. In a
          ...
          <p>
            ...
            recognized. In 1892 four more chapters were established, three of which exist today (the
          ...
          <blockquote className="ml-4 border-l-4 border-delta-red pl-4 italic text-gray-600 dark:text-gray-400">
            ...
            the beginning the jobs of editor and business manager so interwove and over-lapped
          ...
          <p>
            ...
            chapters and fewer than 3,000 alumni.
          </p>
          <p>
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 space-y-4 text-gray-700 dark:text-gray-300">
          ...
          <p>
            There were other internal improvements during the period between the World Wars. The
            position of Executive Secretary was created in 1923 and provision made for a permanent
            central office which was finally established in 1929. The position of Director of Scholarship
            came into being in 1925 to lead the drive for general scholastic excellence. In 1927, one
            full-time Field Secretary was placed in direct contact with the chapters and, in 1935 a
            second one was added to the staff. By 1930, Delta Chi had grown to 36 chapters and, in
            1934, the Headquarters began publishing the Quarterly.
          </p>
          <p>
            During this era Delta Chi made two noteworthy contributions to the Greek letter fraternity
            world. The first of these was the Tutorial Advisor Plan–members of the faculty (preferably
            not members of the Fraternity) living in the house where they acted as tutors, advisors, and
            counselors.
          </p>
          <p>
          ...
          <p>
            ...
            need, desire, and concept were not forgotten. After the war, Delta Chi saw its conference
            program expand and become more purposeful.
          </p>
          <p>
            Today the Regional Conferences play an important role in the affairs of the fraternity. The
            conferences are the vehicle for the election of each Regent for a two-year term. More
            important, each conference is designed to accomplish specific purposes, including the
            development of new approaches to the solution of Fraternity problems; fostering a better
            understanding of the operation of the various programs of the general Fraternity and the
            Headquarters; promoting good will in university-fraternity relations; and bringing together
            large numbers of Delta Chis for information, inspiration, and plain good fun.
          </p>
          <p>
            After the Great Depression and on the verge of the United States entering World War II, the
            Fraternity celebrated its 50th Anniversary with 35 chapters. Once again our young men
            went off to war and many of the chapter houses were taken over by the military as was
            done during the first world war. It was the alumni dues program, started in 1935, that
            provided the main source of revenue to the Fraternity while the chapters were not in
            operation.
          </p>
          <p>
            The war ended and the chapters resumed normal operations. By 1950, Delta Chi had 39
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 space-y-4 text-gray-700 dark:text-gray-300">
          ...
          <p>
            Also at the 1962 Convention, the Regional Representatives were redesignated as Regents
            and the Executive Board was renamed the Board of Regents.
          </p>
          <p>
            In 1969, the Fraternity moved out of rented space into its first permanent facility. The
            property is wholly owned by Delta Chi and houses the archives of the Fraternity and a staff
            of three directors, five traveling consultants and three clerical employees.
          </p>
          <p>
          ...
          <p>
            While there have been a variety of changes that have strengthened Delta Chi within the last
            decade, the 80s will most probably be remembered for the growth in chapters. Starting with
            78 chapters and colonies in 1980, the Fraternity celebrated at its Centennial Convention
      ...
      <section className="mt-12">
        ...
        <p className="mt-4 text-gray-600 dark:text-gray-400">
          The friendships formed during your undergraduate years are relationships that will last far beyond graduation. Delta Chi was founded on the principle of bringing together men of similar interests to work towards a common good—personal development through brotherhood.
        </p>
      </section>
